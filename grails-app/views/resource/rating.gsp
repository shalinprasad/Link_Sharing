<%@ page import="link_sharing.Document_Resource" %>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <g:if test="${resource.createdBy.username==session.name}">
                                <g:if test="${resource.hasProperty("documentpath")}">
                                    <div class="col-md-1">
                        ...
                        <div class="modal-body">
                            <g:uploadForm  controller="topic" action="editDocument" params="[id:resource.id,tname:resource.topics.name]" class="topicForm">
                                Document *:
                                <g:if test="${resource.hasProperty("documentpath")}">
                                    <input type="file" class="form-control" id="doc" placeholder="choose"  name="document">${resource.documentpath}
                                </g:if>
                                <g:else>
                                ...
                                Topic:
                                <label class="form-control" type="text"  name="topicName" id="topicName" >"${resource.topics.name}"</label>
